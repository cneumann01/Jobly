...
class User {
	...
	static async get(username) {
		...
		// Get the list of job IDs the user has applied for
		...
		const jobIds = applicationsRes.rows.map((row) => row.jobId);
	 ...
	 *
	 * Adds an application with username and jobId to the database.
	 *
